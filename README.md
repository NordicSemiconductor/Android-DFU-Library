...
# Somewear 
## Generate artifact and upload to maven
[!This upload process could benefit from its own script - for now this works] 

1. Create a new release version in Android-DFU-Library 
2. Clone soulva respository
